...
const PRG: &str = "headr";
const EMPTY: &str = "headr/tests/inputs/empty.txt";
const ONE: &str = "headr/tests/inputs/one.txt";
const TWO: &str = "headr/tests/inputs/two.txt";
const THREE: &str = "headr/tests/inputs/three.txt";
const TWELVE: &str = "headr/tests/inputs/twelve.txt";
...
// --------------------------------------------------
#[test]
fn fails_bytes_and_lines() -> Result<()> {
